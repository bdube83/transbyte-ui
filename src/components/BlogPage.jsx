...
import { FaClock, FaUser, FaArrowRight, FaLightbulb, FaArrowLeft } from "react-icons/fa";
  ...
  return (
    <div className={`${styles.paddingX} bg-primary min-h-screen text-white py-16`}>
      <div className={`${styles.boxWidth} mx-auto`}>
          ...
          <div key={post.id} className="mb-16">
            <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 p-8 rounded-lg border border-gray-600">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <a 
                  href={`/blog/${post.id}`}
                  className="inline-flex items-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors group text-lg font-medium"
                >
                  Read Full Article
        ...
        {/* Other Posts */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-white">More Articles</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {blogPosts.filter(post => !post.featured).map((post) => (
              <div key={post.id} className="bg-gray-800/50 p-8 rounded-lg border border-gray-600 hover:border-gray-500 transition-all">
                <div className="flex items-center mb-4">
        ...
        {/* Newsletter Signup */}
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 p-8 rounded-lg text-center mb-16">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center max-w-md mx-auto">
            <input 
              ...
              className="flex-1 px-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-600 focus:border-blue-500 focus:outline-none text-lg"
            />
        ...
        <div className="text-center bg-gradient-to-r from-green-600/20 to-blue-600/20 p-8 rounded-lg">
          <h3 className="text-3xl font-bold text-white mb-4">Ready to Deploy Edge AI?</h3>
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto text-lg">
            Join our pilot program and experience the benefits of edge AI in your South African business environment.
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <a 
              href="/#early-access" 
              className="px-8 py-4 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors font-medium text-lg"
            >
              Get Early Access
            </a>
          </div>
